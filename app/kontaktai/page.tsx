    ...
    <div ref={containerRef}>
      <section data-hero-bg className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 data-hero-title className="text-foreground font-bold tracking-tight">kontaktai</h1>
          <Spacer y={4} />
      ...
      <section data-reveal className="py-20 px-6 bg-content1">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 data-reveal-heading className="text-foreground font-bold mb-4">kontaktai</h2>
